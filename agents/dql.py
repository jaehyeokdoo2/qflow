...
class DQLAgent(flax.struct.PyTreeNode):
    ...
    def actor_loss(self, batch, grad_params, rng):
        ...
        pred = self.network.select('actor_diffusion')(observations, x_t, t, is_encoded=True, params=grad_params)
        ...
        # Total loss.
        actor_loss = self.config['alpha'] * diffusion_loss + q_loss
                ...
                if energy_grad_fn is not None:
                    ...
                    def q_fn_at_target(a_t):
                        if pred_clean:
                            ...
                            a_0 = (a_t - sqrt_one_minus_alphas_cumprod * preds) / sqrt_alphas
